...
href="http://www.keio.ac.jp/">Keio University</a>). All Rights
    ...
    <address>Created by <a href="http://www.w3.org/People/Dom/">Dominique Haza&#235;l-Massieux</a>, developed with contributions from others (see esp. the <a href="http://dev.w3.org/cvsweb/2004/rdfs2html/rdfs2html.xsl">version in W3C Public CVS server</a>) - $Id: rdfs2html.xsl,v 1.52 2004/03/23 09:13:50 dom Exp $</address>
    </body>
  </html>
  ...
  <xsl:template match="/">
    ...
    <html>
      ...
      <body>
        ...
        <hr/>
        <address>
          <xsl:value-of select=".//*[@rdf:about='']/rcs:id"/> (HTML display done through <a href="http://www.w3.org/2002/06/rdfs2html.xsl">http://www.w3.org/2002/06/rdfs2html.xsl</a> $Id: rdfs2html.xsl,v 1.52 2004/03/23 09:13:50 dom Exp $)
        </address>
      </body>
    </html>
  </xsl:template>
  ...
  <xsl:template match="*" mode="details">
   <xsl:if test="@rdf:ID or @ID or @rdf:about or @about">
    ...
    <xsl:if test="rdfs:comment">
      <dd class="description"><xsl:value-of select="normalize-space(rdfs:comment)"/></dd>
    </xsl:if>
